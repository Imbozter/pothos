    ...
    > {
      prismaField: <
        ...
        Model extends PrismaModelTypes = PrismaModelTypes &
          (TypeParam extends [keyof Types['PrismaTypes']]
            ...
            : TypeParam extends [PrismaObjectRef<Types, PrismaModelTypes>]
      ...
      prismaConnection: 'relay' extends PluginName
        ? <
            ...
            ResolveReturnShape,
            Args extends InputFieldMap = {},
            Model extends PrismaModelTypes = Type extends PrismaObjectRef<Types, infer T>
              ? T
              : PrismaModelTypes & Types['PrismaTypes'][Type & keyof Types['PrismaTypes']],
            Shape = Type extends PrismaObjectRef<Types, PrismaModelTypes, infer S>
              ? S
              : Model['Shape'],
